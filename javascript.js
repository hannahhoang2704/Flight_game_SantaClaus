...
function rock_paper_scissors() {
  ...
  document.getElementById('rps-up').appendChild(rps_div)
...
async function checkComputerOption(playerValue) {                 // asynchronous function is defined by the async keyword
  try {                                               // error handling: try/catch/finally
    ...
    document.getElementById('rps-up').appendChild(h2)
...
async function airportFetches() {                 // asynchronous function is defined by the async keyword
  ...
  try {                                               // error handling: try/catch/finally
    ...
    div_ICAO.appendChild(ICAO_p);
>>>>>>> f6bd908 (Added new element in html with id rps-up to reposition rps game. Made changes in JS where I appended rps up.In JS fixed the map zoom.)
